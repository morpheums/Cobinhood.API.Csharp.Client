...
namespace Cobinhood.API.Csharp.Client
{
    public class ApiClient : ApiClientAbstract, IApiClient
    {
        ...
        public ApiClient(string apiKey, string apiSecret, string apiUrl = @"https://api.cobinhood.com", string webSocketEndpoint = @"wss://feed.cobinhood.com/ws", bool addDefaultHeaders = true) : base(apiKey, apiSecret, apiUrl, webSocketEndpoint, addDefaultHeaders)
        {
        }
